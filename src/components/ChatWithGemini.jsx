  ...
  return (
    <Box className="flex flex-col items-center justify-center">
      <Box className="flex flex-col items-center justify-center">
        ...
        <TextRenderer
          value="Your Virtual Health Companion, Guiding You to Better Well-being"
          direction={"l"}
        />
      </Box>
    </Box>
      ...
      <>
        ...
        >
          <ReactMarkdown
            ...
            components={{
              p: ({ node, ...props }) => (
                <Text {...props} className="text-sm break-words" />
              ),
              code: ({ node, ...props }) => (
                <pre
                  {...props}
                  className="text-sm font-mono text-white bg-slate-800 rounded-md p-2 overflow-auto m-2 break-words"
                />
              ),
            }}
          >
